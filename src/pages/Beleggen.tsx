...
const articles = [
  ...
  { tag: 'Broker', title: 'Trading 212 review. Gratis beleggen, maar wat zijn de haken?', summary: 'Trading 212 biedt gratis beleggen. Maar hoe verdienen ze dan geld? En is het veilig?', readTime: 5, path: '/beleggen', affiliate: true },
  { tag: 'Broker', title: 'DEGIRO vs Trading 212. Welke is beter?', summary: 'Een eerlijke vergelijking van de twee populairste brokers in Nederland.', readTime: 7, path: '/beleggen', affiliate: true },
  { tag: "ETF's", title: "Wat is een ETF? Uitgelegd in gewone taal", summary: "Indexfondsen zijn de slimste manier om te beleggen voor de meeste mensen. Dit is waarom.", readTime: 6, path: '/beleggen', affiliate: false },
  ...
  { tag: "ETF's", title: "IWDA ETF. Alles wat je moet weten", summary: "De iShares Core MSCI World ETF is een van de populairste ETF's ter wereld. Dit is waarom.", readTime: 7, path: '/beleggen', affiliate: false },
  ...
  { tag: 'Aandelen', title: 'Aandelen kopen als beginner. Zo doe je het veilig', summary: 'Stappenplan om je eerste aandelen te kopen zonder dure fouten te maken.', readTime: 6, path: '/beleggen', affiliate: false },
  { tag: 'Dividend', title: 'Dividend beleggen, zo bouw je passief inkomen op', summary: 'Hoe je een dividendportefeuille opbouwt die elke maand of kwartaal uitkeert.', readTime: 7, path: '/beleggen', affiliate: true },
]
