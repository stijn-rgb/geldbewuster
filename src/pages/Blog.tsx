...
const allArticles = [
  ...
  { tag: "ETF's", title: 'Wat is een ETF? Uitgelegd in gewone taal', summary: "IWDA, VWRL, VUSA, welke indexfondsen zijn het meest geschikt voor een Nederlandse belegger?", readTime: 9, path: '/beleggen/wat-is-een-etf', live: true, affiliate: true },
  ...
  { tag: 'Broker', title: 'Trading 212 review 2026: gratis beleggen, wat is de catch?', summary: 'Trading 212 biedt gratis beleggen. Hoe verdienen ze geld en is het veilig voor Nederlandse beleggers?', readTime: 6, path: '/beleggen/trading-212-review', live: true, affiliate: true },
  ...
  { tag: "ETF's", title: 'IWDA ETF: alles wat je moet weten in 2026', summary: 'De iShares Core MSCI World is voor veel Nederlanders de kern van hun portefeuille. Wat zit erin en waarom werkt het?', readTime: 7, path: '/beleggen/iwda-etf', live: true, affiliate: true },
  ...
  { tag: 'Beleggen', title: 'Aandelen kopen als beginner: zo doe je het veilig', summary: 'Stappenplan om je eerste aandelen te kopen zonder dure fouten te maken.', readTime: 6, path: '/beleggen/aandelen-kopen-beginner', live: true, affiliate: true },
  { tag: 'Vermogen', title: 'Dividend beleggen: zo bouw je passief inkomen op in 2026', summary: 'Hoe je een dividendportefeuille opbouwt die elke maand of kwartaal uitkeert.', readTime: 7, path: '/beleggen/dividend-beleggen', live: true, affiliate: true },
  ...
  { tag: 'Verzekeringen', title: "Zorgverzekering vergelijken 2026: bespaar honderden euro's", summary: 'Zo vind je de goedkoopste zorgverzekering die bij jou past.', readTime: 7, path: '/verzekeringen/zorgverzekering-vergelijken', live: true, affiliate: true },
