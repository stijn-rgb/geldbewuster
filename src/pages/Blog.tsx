...
const allArticles = [
  ...
  { tag: 'Sparen', title: 'Beste spaarrekening Nederland 2026', summary: 'Welke bank biedt de hoogste spaarrente? Ons actuele overzicht van alle grote aanbieders.', readTime: 5, path: '/sparen/beste-spaarrekening', live: false, affiliate: true },
