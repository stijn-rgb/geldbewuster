    ...
    <>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <InfoCard icon="📈" title="Beleggen" body="Aandelen, ETF's en fondsen. Laat je geld voor je werken op de lange termijn." />
          <InfoCard icon="₿" title="Crypto" body="Bitcoin, Ethereum en andere cryptomunten. Hoog risico, maar ook hoog potentieel." />
          <InfoCard icon="🏦" title="ETF's" body="Indexfondsen zijn de slimste keuze voor de meeste mensen. Gespreid en goedkoop." />
        </div>
